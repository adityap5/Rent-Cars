...
import logo from '/footer/logow.png'
import tri from '/page3/tri.png'
import ios from '/ios.png'
import and from '/and.png'
import main from '/footer/main.png'
function Footer() {
  return (
    ...
    <div className="static">
        ...
        alt="" />
        <div className='flex justify-between absolute left-8 top-[3900px]'>
    ...
    <h1 className='text-4xl  mt-6'>Download Rentcars <br /> App for <span className='text-blue'>FREE</span></h1>  
     <p className='text-txt mt-4'>For faster, easier booking and exclusive deals.</p>     
     <div className="flex place-content-start gap-2 mt-4">
               <img src={and} alt="" />
               <img src={ios} alt="" />
                </div>
            </div>
    ...
    <div className='mt-6'>
            ...
            <div className="h-1/2 w-full bg-[#051C34]">
...
<p className="text-white font-semibold">RENTCARS</p>
        </div>
  ...
  <hr className=" max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8"/>    
            <p class="text-center text-gray-400">Copyright 2024 ・ Rentcars, All Rights Reserved</p>
</footer>
            </div>
